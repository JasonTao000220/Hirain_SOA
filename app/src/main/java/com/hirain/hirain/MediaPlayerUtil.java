...
public class MediaPlayerUtil {
        ...
        public void stop() {
            ...
            if (status == MediaPlayStatus.PAUSED || status == MediaPlayStatus.STARTED || status == MediaPlayStatus.PREPARED
                    || status == MediaPlayStatus.PLAYBACK_COMPLETED || status == MediaPlayStatus.STOPPED) {
        ...
        public void start() {
            ...
            if (status == MediaPlayStatus.PREPARED || status == MediaPlayStatus.STARTED
                    || status == MediaPlayStatus.PAUSED || status == MediaPlayStatus.PLAYBACK_COMPLETED) {
                singleExecutor.execute(() -> {
                    player.start();
